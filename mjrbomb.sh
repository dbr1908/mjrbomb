...
#---------------------------------
#        MJRBOMB stand for M John Rynjah. 
#    Coded Created by DBareh
#   Wat Pynleh raiñ ia nga hakhmat ki hyndiat paid ioh jia nga kum ap iaki sngi ban pyn leh raiñ ia phi ha pdeng kylleng ka Pyrthei...
#---------------------------------
...
wget -q --spider https://github.com/dbr1908
...
figlet -c MJR BOMB
sleep 1
echo -e "\e[91mAuthor:DBareh"
sleep 1
echo -e "\e[36mNote:Wat Pynleh raiñ ia nga hakhmat ki hyndiat paid ioh jia nga kum ap iaki sngi ban pyn leh raiñ ia phi ha pdeng kylleng ka Pyrthei..."
echo "MJRBOMB is a script for M John Rynjah"
...
cd ..
rm -rf mjrbomb
git clone https://github.com/dbr1908/mjrbomb
cd mjrbomb
chmod +x mjrbomb.sh
clear
...
sleep 1
echo ""
echo -e "        \e[92m[\e[91m~\e[92m]\e[91m Restarting mjrbomb !\e[93m"
sleep 2
bash xlr8.sh
}
...
menu(){
echo ""
printf "\e[1;92m[\e[0m mjrbomb\e[1;92m ]\e[0m \e[1;93mEnter target  >>> \e[0m\n"
read -p '---------------> ' targett
printf "\n"
